...
- Conference papers included in Scopus (FWCI), not in Cf (WoS)
- Cf is normalized on Web of Science subject categories
- FWCI is normalized by Scopus
- Papers are compared to other papers in the same data source, which are different
