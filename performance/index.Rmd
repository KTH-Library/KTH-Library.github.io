...
abm_data(unit_code = 177) %>% show_query()
#abm_data(unit_code = 177) %>% explain()  # for query plan used in db
...
## Adding indexes and tuning a query {.smaller}
    ...
    sqlite> SELECT *
       ...> FROM `masterfile`
       ...> WHERE (`Unit_code` IN (177.0));
    Run Time: real 0.070 user 0.062024 sys 0.007987
    
    sqlite> select * from masterfile where Unit_code = 177;
    Run Time: real 0.056 user 0.043066 sys 0.012977
    ...
    sqlite> select * from masterfile where Unit_code = 177;
    Run Time: real 0.001 user 0.000241 sys 0.000074
    
    sqlite> select * from masterfile where Unit_code in (177);
    Run Time: real 0.001 user 0.001682 sys 0.000000
...
EXPLAIN the query plan (shows that index is being used)
    ...
    sqlite> .eqp on
    sqlite> select * from masterfile where Unit_code in (177);
    --EQP-- 0,0,0,SEARCH TABLE masterfile USING INDEX idx1 (Unit_code=?)
    Run Time: real 0.000 user 0.000391 sys 0.000000
