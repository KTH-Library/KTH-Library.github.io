...
## Enrichment and supplementing missing and/or incomplete data

- Example: Project Field/ID
  
  - For ~480 intersected projects, we are able to reduce the degree of incompleteness in the the project ID field from ~10 to < 3% using equivalent fields in openAire and Swecris.
