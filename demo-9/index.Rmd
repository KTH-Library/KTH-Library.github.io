...
## Mobilized data sources for KTH projects {.smaller}
...
tribble(
  ...
  "OpenAIRE", "https://graph.openaire.eu/develop/api.html#projects", TRUE, "project_openaire.csv", "OpenAIRE", 813, 10, "daily",
  "Swecris", "https://swecris-api.vr.se/index.html", TRUE, "project_swecris.csv", "swecris", 3165, 26, "daily",
  "Vinnova", "https://www.vinnova.se/en/about-us/about-the-website/open-data/", TRUE, "project_vinnova.csv", "vinnova", 442, 20, "daily",
  "CORDIS", "https://data.europa.eu/data/datasets/cordis-eu-research-projects-under-horizon-europe-2021-2027?locale=en", TRUE, "project_cordis.csv", "cordis", 753, 20, "monthly",
...
### Tools for matching and combining etc

- <https://github.com/KTH-Library/kthcorpus> (open repo, publication and authors in DiVA etc)
- <https://github.com/KTH-Library/institutions> (open repo, organisation identifers etc)
- <https://github.com/KTH-Library/bibliotools> (private repo, access to CASE data)


## CASE: a Research Management process in Edge

  - Internal source at KTH (Edge, Efecte) - a "Case Management System for Research Projects"
...
[Synergies and Challenges of Integrating Heterogeneous KTH Project Datasets](file:///D:/swecris/data-raw/sweCrisQo.html)
