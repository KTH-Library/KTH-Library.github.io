...
- [Authenticated ABM app](https://kth.se/abm){target="_blank"}
- [Public ABM app](https://kth.se/abm/public){target="_blank"}
...
- [Systems configuration (confluence, authenticated)](https://confluence.sys.kth.se/confluence/pages/viewpage.action?pageId=70784672){target="_blank"}
...
- [API Documentation](https://bibliometrics.lib.kth.se/qc/__docs__/){target="_blank"}
- [Source code](https://github.com/kth-library/kthcorpus){target="_blank"}

## HR + DiVA Team tools/services

- [Object storage for data](https://data.lib.kth.se){target="_blank"} *minio used*
