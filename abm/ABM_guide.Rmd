...
The *Scopus* tab presents bibliometric indicator data based on the Scopus database, as a complement to the data in the tabs *Citation impact*, *Journal impact* and *Co-publishing*. 
This tab has sub-tabs
