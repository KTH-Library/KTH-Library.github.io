---
title: "Demo #10 - Datadriven Analys och Uppföljning av KTHs Forskning (DAUF)"
...
-   New **research portfolio management structure** is taking shape and governs the DAUF project
...
-   Progress in **data mobilization** - imports for DiVA publications etc
...
-   New **landing page** at <https://bibliometrics.lib.kth.se>
...
-   Link out to **profile pages** at kth.se
-   Improved **export** functionality
-   **Subject area** analysis
-   **Topic clusters** and keywords
-   **Journal** classifications
-   **Open Access** tab
-   Explore **co-publication** collaborations at KTH
...
::: {.column width="45%"}
![Publications registered in total](assets/img/pubs-registered.png)
:::
...
::: {.column width="45%"}
![Share of researcher registered articles](article_share.png){}
:::

::: {.column width="45%"}
![Share of researcher registered conference papers](conf_share.png){}
:::
...
Software upgrade for **object storage** (S3 / minio) at <https://data.bibliometrics.lib.kth.se> which improves on user management, provides SFTP support and more.

<center>
![https://data.bibliometrics.lib.kth.se](assets/img/minio-kth.png){height="300"}
</center>

> Should we publish more "open data" (without Personally Identifiable Information) to support general use elsewhere at KTH? For example ABM indicators for 2023, information about organizational units at KTH, information about projects at KTH etc?
