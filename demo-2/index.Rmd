...
- Questions on the bibliometric evaluation model was raised.  
  - **organization based**: Evaluation of KTH-output and higher precision. Will add further **FAQ** to the ABM to answer common concerns and questions.
  
- Incorrect mappings and wrongly assigned publications  
  - **based on school dialog** and checks by researchers
  
- Clearer view of incentives and how publications contribute to impact  
  - E.g. **list** of top-contributing papers and journals


## From previous demo

- **Data access** and exports were requested.  
  - We are developing **an API** (currenlty JSON data) and an R package which bundles "public" data (without requiring database credentials).

- **Data sources** were discussed, including possible additions  
  - We are testing Scopus data, to add this as complementary data (citation counts, Scopus coverage).
  - We also intend to add functionality to the R package, to provide access to relevant **open data sources** (e.g. Microsoft Academic, Altmetric, Google Scholar etc).
