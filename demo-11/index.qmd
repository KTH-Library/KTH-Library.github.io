...
> GDP (Gemensamma data för projekt) is an effort of a number of Swedish research funders to create a common data model for project data. The five funding agencies Energimyndigheten, Formas, Forte, Vetenskapsrådet and Vinnova is developing a standard which enables sharing of open data about fundings and related information. The standard is developed in cooperation with a reference group including universities and other organisations within the university sector, KTH is a participant in the reference group.
...
Enrichment of DiVA publications - an example associating SDG goals with theses from KTH:

- [Enrichment of theses at KTH using SDGs from Aurora classifier](enrichment.html)

# Data infrastructure

- A data lake is powered by ["minio"](https://minio.org) - and provides object storage compatible with the S3 protocol
- Data is curated and pushed to "minio" using automated processes
- Applications and data consumers can then read data from "minio"
