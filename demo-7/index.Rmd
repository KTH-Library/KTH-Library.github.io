...
- To show previous examples of copublication data and how it can be used
...
> 3. Allow the ability to view data at different organization levels and at author-name level
...
:::: {style="display: flex;gap: 20px 20px;"}
::: {}
