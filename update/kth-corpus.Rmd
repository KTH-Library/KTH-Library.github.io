...
- Tools such as "diva" R package deployed on "kontarion" stack

## 

![Example flows for "bibib" setup](bibib.svg){height=500;}
...
Can meet needs from other apps/tools/services, such as "DiVA apan"...

## Missing pieces

- A data backend server for hosting Apache Spark (for more info see https://blog.min.io/modern-data-lake-with-minio-part-1/ and https://blog.min.io/modern-data-lake-with-minio-part-2/)
