...
## Data Curation - overview {.smaller}

- Preparations under way for migration to future **new DiVA**
  - Launch of new DiVA with API is postponed, **new timeline**
  - All **records need review** to meet new DiVA requirements
  - Updates also required for KTH curation tools and processes

- Broader discussions in KTH relating to a future **data lake for "KTH Works"**
  - Publication data mirrored in separate system under control from KTH
  - Ability to cross reference other research outputs and auxiliary data from **external sources**
  - Free to revamp curation process; increase automation and **data enrichment** from external sources, sync to DiVA repository etc

## Data Curation and data flows {.smaller}
