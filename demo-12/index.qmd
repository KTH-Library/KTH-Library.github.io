...
format: 
  kth-quarto-revealjs:
    ...
    footer: "DAUF - Demo 12 - 2025-12-05"
---
...
# Swedish bibliometrics & OpenAlex {.smaller}

![](assets/img/openalex_logo.png){height="400"}
...
![](https://www.openalex.duckdns.org/logo.jpeg){width="100%"}

## Current status

- Server running on Sunet for snapshot download and data processing
- Flattening of json to .parquet
- Database using [duckdb](https://duckdb.org/)
- Access by database connections and [sql requests through basic API](https://openalex.duckdns.org/api/)
...
![SQL workbench "Pond Pilot" (wasm) for combining DiVA, OpenAlex and other data sources](ui.png)
