...
- Sverige har saknat en nationell ansats eller gemensamma system
- Forskningsproposition pekar mot större öppenhet kring forskningsutvärdering

**OpenAlex**

![](assets/img/openalex_logo.png){.r-stretch}

- Öppen resurs, härstammar från Microsoft Academic (stängdes 2021)
- Webgränssnitt och API (json)
- 

## Status

- System för nedladdning och utplattning
