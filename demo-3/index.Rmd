...
First step of project plan was a re-implementation of the functionality in the old ABM.

- Same results, based on DiVA and Bibmet
- More attractive and dynamic presentation
- Share uncited publications
- Open-access overview

Currently released version meets these goals, with easy login though KTH and a public version of the app.
...
![](screenshot_uncited.png){height=300}
...
What would be most interesting to you in the short run?
...
Feel free to look at these resources if you are interested in the workflow and implementation.
