...
# Tools
url_data <- data.frame(url = c("https://github.com/KTH-Library/swecris",
                               "https://github.com/KTH-Library/formas",
                               "https://github.com/KTH-Library/vinnova",
                               "https://github.com/KTH-Library/cordis",
                               "https://github.com/KTH-Library/OpenAIRE",
...
summary_table <- data.frame(
  ...
  mutate(Open = c(rep("🟢",5),"🔒")) |> 
  mutate(Tools = paste0("<a href='",
                        url_data$url,"'>",
                        url_data$url,
                        "</a>")) |> 
  mutate(Updates = c("daily","daily","daily","monthly","daily","daily"))

# Table
DT::datatable(summary_table,colnames = c('Source', 'Records',
                                         'Fields','Access',"Tools","Updates"), escape = FALSE)
```
