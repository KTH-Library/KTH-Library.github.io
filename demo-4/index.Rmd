...
- The "old" ABM / ÅBU has been sunsetted / retired and outreach communications was made about the new "ABM" on the KTH Intranet
...
![](ux-board.png){width=300}

Trello board reflecting feeback captured from Demo-3-meeting in the area of UX improvements
...
A corresponding set of layout fixes implemented and rolled out to the [reference environment](https://shiny-2-r.referens.sys.kth.se/)
...
<iframe width="560" height="315" src="abm-layout-fixes.mp4" frameborder="0" allowfullscreen></iframe>
...
- More UX work - should we add more interactivity before rolling out the service update to production servers?
...
- Other apps to complement the existing ABM
