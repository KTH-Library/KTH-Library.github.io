...
- OA data and associated Altmetric data has also been updated

## Scopus addition

- Data related to KTH-publications will be purchased with updates the coming years
- Use in relation to coming RAE 
...
[Link to ABM on reference server](https://https://shiny-2-r.referens.sys.kth.se/app_direct/abm/)
...
## Questions to Demo-4 group

- Some of you requested UX improvements that have been implemented - in general, do these resolve your reported issues?
